        ...
        <div className="min-h-screen flex items-center justify-center p-4 font-sans overflow-y-auto">
            <div className="max-w-md w-full card-glass transform transition-all duration-300 my-8">
                <div className="gradient-header-primary flex flex-col items-center py-6">
                    ...
                    <h2 className="text-3xl font-bold text-white mb-2 font-display text-glow">bsmartgen</h2>
                    <p className="text-primary-100 text-base">Super Admin Portal</p>
                </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    required
                                    className="input-field-glow pr-10"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowPassword(!showPassword)}
                                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-primary-600 transition-colors focus:outline-none"
                                >
                                    {showPassword ? (

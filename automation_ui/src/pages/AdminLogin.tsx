...
const AdminLogin: React.FC = () => {
    ...
    useEffect(() => {
        if (isAuthenticated && user?.role === 'SUB_ADMIN') {
        ...
        <div className="min-h-screen flex items-center justify-center p-4 font-sans overflow-y-auto bg-slate-50/50">
            <div className="max-w-md w-full card-glass transform transition-all duration-300 my-8">
                <div className="gradient-header-secondary flex flex-col items-center py-6">
                    ...
                    <p className="text-secondary-100 text-base">Sign in to your dashboard</p>
                </div>
                ...
                <div className="bg-gradient-to-r from-secondary-50/50 to-purple-50/50 p-4 text-center border-t-2 border-secondary-200/30 rounded-b-2xl">
                    ...
                    <p className="text-xs text-slate-600 font-medium">
                        Don't have an account? <Link to="/register" className="text-secondary-600 hover:underline">Register</Link>
                    </p>
                </div>
            </div>
        </div>
